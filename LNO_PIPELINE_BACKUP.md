# LNO Pipeline: Complete Embedded Backup

This document is a standalone source-level backup of the current LNO
...
experiment:
  name: "DrivAerML_LNO_SATLOSS6"
  model_name: "LNO_SATLOSS6"
  init_ckpt: ""
  architecture:
    n_block: 8
    n_mode: 256
...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_lno_satloss6")
def main(cfg: DictConfig):
