# PointNet++ SSG Pipeline: Complete Embedded Backup

This document is a standalone source-level backup of the current PointNet++ SSG
...
experiment:
  name: "DrivAerML_POINTNET2_SSG"
  model_name: "POINTNET2_SSG"
  architecture:
    latent_dim: 256
    # Radii are in the normalized DrivAerML coordinate system.  These values
    # keep the first level local and the second level moderately regional.
    sa1_npoint: 2048
    sa1_radius: 0.02
    sa1_nsample: 64
    sa2_npoint: 512
    ...
    sa2_nsample: 128
    query_neighbors: 3
    # Random set-abstraction centroids preserve input-density shifts for the
    # sampling-sensitivity benchmark. Set to fps for canonical PointNet++.
...
experiment:
  name: "DrivAerML_POINTNET2_SSG_SATLOSS6"
  model_name: "POINTNET2_SSG_SATLOSS6"
  init_ckpt: ""
  architecture:
    latent_dim: 256
    # Keep the architecture identical to vanilla PointNet++ SSG.  Radii are
    # expressed in normalized DrivAerML coordinates.
    sa1_npoint: 2048
    sa1_radius: 0.02
    sa1_nsample: 64
    sa2_npoint: 512
    ...
    sa2_nsample: 128
    query_neighbors: 3
    # Keep vanilla and SATLOSS6 architecturally identical while preserving
    # input-density shifts in the set-abstraction centroids.
    centroid_sampling: random
    density_histogram_bins: 8
    pos_scale_factor: 1.0
    query_chunk_size: 65536
...
### Model dependency: models/family_common.py
...
### Model dependency: models/smart/smart.py
...
### PointNet++ SSG model implementation
...
### PointNet++ SSG vanilla entry point
...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_pointnet2_ssg")
...
### PointNet++ SSG SATLOSS6 entry point
...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_pointnet2_ssg_satloss6")
def main(cfg: DictConfig):
