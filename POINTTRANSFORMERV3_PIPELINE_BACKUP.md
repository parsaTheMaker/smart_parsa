# PointTransformerV3 Pipeline: Complete Embedded Backup

This document is a standalone source-level backup of the current PointTransformerV3
...
experiment:
  name: "DrivAerML_POINT_TRANSFORMER_V3_SATLOSS6"
  model_name: "POINT_TRANSFORMER_V3_SATLOSS6"
  architecture:
    in_channels: 3
    grid_size: 0.0078125
    latent_dim: 192
...
### Model dependency: models/ptv3_serialization.py
...
### PointTransformerV3 model implementation
...
### PointTransformerV3 vanilla entry point
...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_point_transformer_v3")
...
### PointTransformerV3 SATLOSS6 entry point
