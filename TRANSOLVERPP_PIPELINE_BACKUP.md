# Transolver++ Pipeline: Complete Embedded Backup

This document is a standalone source-level backup of the current Transolver++
...
experiment:
  name: "DrivAerML_TRANSOLVERPP"
  model_name: "TRANSOLVERPP"
  model_tag: ""
  random_seed: 42
  manifest_variant: "full"
...
experiment:
  name: "DrivAerML_TRANSOLVERPP_SATLOSS6"
  model_name: "TRANSOLVERPP_SATLOSS6"
  model_tag: ""
  random_seed: 42
  manifest_variant: "full"
  ...
  log_every_n_steps: 5
  inspect_first_sample: False
  init_ckpt: "/home/parsa/smart_parsa/checkpoints/transolverpp-transolverpp-drivaerml-64k-gpu0-bs2-drivaerml-s42_best.pt"
  resume_ckpt: ""
  resume_full_state: False
  wandb_watch_model: False
...
### Transolver++ model implementation
...
### Transolver++ vanilla entry point
...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_transolverpp")
...
### Transolver++ SATLOSS6 entry point
