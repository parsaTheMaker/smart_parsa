#!/usr/bin/env python3
"""Export and remesh toy FEM surfaces for sampling tests.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--data-root", type=Path, default=Path("/mnt/ssdraid/parsa/toy_perforated_fin_nonlinear_fem_v2"))
    parser.add_argument("--surface-vtp-dir", type=Path, default=Path("/mnt/ssdraid/parsa/toy_perforated_fin_nonlinear_surface_vtp_v2"))
    parser.add_argument("--angle-output-dir", type=Path, default=Path("/mnt/ssdraid/parsa/toy_perforated_fin_nonlinear_surface_vtp_angle_v2"))
    parser.add_argument("--isotropic-output-dir", type=Path, default=Path("/mnt/ssdraid/parsa/toy_perforated_fin_nonlinear_surface_vtp_isotropic_v2"))
    parser.add_argument("--voxel-output-dir", type=Path, default=Path("/mnt/ssdraid/parsa/toy_perforated_fin_nonlinear_surface_vtp_voxel_v2"))
    parser.add_argument("--results-dir", type=Path, default=Path("/home/parsa/smart_parsa/results/toy_perforated_fin_nonlinear_remeshing_v2"))
    parser.add_argument(
        "--case-stem",
        default="perforated_fin_case",
        help="Prefix of per-case surface VTPs, e.g. perforated_fin_case or heat_exchange_case.",
    )
