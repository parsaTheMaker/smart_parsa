...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_mspt_satloss7")
def main(cfg: DictConfig):
    run_consistency_training(cfg, model_ctor=MSPTSATLOSS7, model_requires_density=False)
