...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_sat2")
def main(cfg: DictConfig):
    run_consistency_training(cfg, model_ctor=SMARTSAT2, model_requires_density=True)
