"""DeAL/SATLOSS7 continuation for Geo-FNO on Heat Exchanger."""
...
@hydra.main(version_base="1.2", config_path="config", config_name="toy_heat_exchange_geo_fno_deal_from_base")
