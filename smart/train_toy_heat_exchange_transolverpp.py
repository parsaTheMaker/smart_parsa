"""Vanilla Transolver++ training entry point for toy heat exchange."""
...
@hydra.main(version_base="1.2", config_path="config", config_name="toy_heat_exchange_transolverpp")
