"""SATLOSS training entrypoint for the mesh-FEM perforated-fin benchmark."""
...
@hydra.main(version_base="1.2", config_path="config", config_name="toy_perforated_fin_satloss7")
