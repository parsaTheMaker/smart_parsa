...
class TransolverPPSATLOSS8(TransolverPP):
...
@hydra.main(version_base="1.2", config_path="config", config_name="drivaerml_transolverpp_satloss8")
def main(cfg: DictConfig):
    run_consistency_training(cfg, model_ctor=TransolverPPSATLOSS8, model_requires_density=False)
